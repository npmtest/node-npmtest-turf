...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-turf/node_modules/turf-planepoint/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-turf/node_modules/turf-planepoint/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-turf/node_modules/turf-planepoint/</a> &#187; index.js</div>
</div>
<div class="body">
 ...
 * //=zValue
 */
module.exports = <span class="fstat-no" title="function not covered" >function (point, triangle) {</span>
<span class="cstat-no" title="statement not covered" >    var x = point.geometry.coordinates[0],</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var z = (z3 * (x - x1) * (y - y2) + z1 * (x - x2) * (y - y3) + z2 * (x - x3) * (y - y1) -</span>
