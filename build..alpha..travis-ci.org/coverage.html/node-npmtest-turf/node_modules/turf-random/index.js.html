...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-turf/node_modules/turf-random/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-turf/node_modules/turf-random/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-turf/node_modules/turf-random/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var random = require('geojson-random');
&nbsp;
/**
 ...
 * //=polygons
 */
module.exports = <span class="fstat-no" title="function not covered" >function (type, count, options) {</span>
...
<span class="cstat-no" title="statement not covered" >    switch (type) {</span>
    ...
    case 'points':
    case undefined:
<span class="cstat-no" title="statement not covered" >        return random.point(count, options.bbox);</span>
    case 'polygon':
    case 'polygons':
<span class="cstat-no" title="statement not covered" >        return random.polygon(</span>
                count,
                options.num_vertices,
                options.max_radial_length,
                options.bbox);
    default:
<span class="cstat-no" title="statement not covered" >        throw new Error('Unknown type given: valid options are points and polygons');</span>
    }
};
&nbsp;
&nbsp;</pre></td></tr>
